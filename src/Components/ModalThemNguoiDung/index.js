...
import { addUserAction } from "../../redux/Admin/admin.actions";
const ModalThemNguoiDung = ({ visible, handleCancel, setDone }) => {
  ...
  const handleSubmit = (values) => {
    ...
    if (
      ...
      dispatch(addUserAction(values, setDone, resetForm));
      handleCancel();
    }
  };
